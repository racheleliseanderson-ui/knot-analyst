 ...
 *
 * Hook the Horizon  — publisher / parent brand
 *   └── Knot Analyst — this product
 *         ├── Fishing
 *         └── Boating & Sailing
 *
 * Application IDs (HTH-KK-001) remain stable for engine provenance; they are
 * not user-facing product names.
 */
