...
export const BOATING_VENUES: DomainVenue[] = [
  {
    ...
    conditions: { needsUntie: true, retieFrequency: "frequent", proficiency: "beginner" },
    punishes:
  ...
  },
  {
    ...
    conditions: { retieFrequency: "occasional", coldHands: true, proficiency: "intermediate" },
    punishes:
  ...
  },
  {
    ...
    conditions: { windy: true, retieFrequency: "rare", proficiency: "intermediate" },
  ...
  },
  {
    ...
    conditions: { mustPassGuides: true, retieFrequency: "frequent", proficiency: "intermediate" },
  ...
  },
  {
    ...
    conditions: { needsUntie: true, windy: true, proficiency: "advanced" },
  ...
  },
  {
    ...
    conditions: { retieFrequency: "rare", proficiency: "advanced", lowLight: true },
