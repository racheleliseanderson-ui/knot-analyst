...
export const CONNECTION_MODEL_META_BOATING: Record<string, ConnectionModelMeta> = {
  "cleat-hitch": {
    ...
    retieTempoFit: "fast",
    strengthRetentionBand: band(70, 95, "Make-fast, not a rope-break figure. BoatUS / Animated Knots: holds when far-horn first turn and lock are dressed."),
  ...
  "round-turn-two-half-hitches": {
    ...
    tieAbilityUnderCondition: tie("good", "good", "fair", "good"),
    retieTempoFit: "fast",
    strengthRetentionBand: band(60, 75, "Animated Knots working-hitch class: round turn carries load, hitches only lock."),
  ...
  "clove-hitch": {
    ...
    strengthRetentionBand: band(60, 70, "Animated Knots: holds when dressed and watched; documented walk-off under cycling load."),
  ...
  "anchor-bend": {
    ...
    strengthRetentionBand: band(70, 80, "Animated Knots / field practice: high hitch band when the round turn is seized or well dressed."),
  ...
  bowline: {
    ...
    tieAbilityUnderCondition: tie("good", "good", "fair", "good"),
    retieTempoFit: "fast",
    strengthRetentionBand: band(60, 75, "Animated Knots typical ~60% class; published tests commonly 60–75%. Can capsize if undressed."),
    failsWhen: ["Undressed collar", "No backup on a critical job", "Tied in HMPE and treated like polyester"],
    diameterMismatchTolerance: "n/a",
    guidesFriendly: true,
    sourceId: "animated-knots",
    reviewedDate: "2026-08-14",
  ...
  "figure-8-loop": {
    ...
    retieTempoFit: "moderate",
    strengthRetentionBand: band(75, 85, "Animated Knots / climbing literature: typically higher and more stable than a bowline."),
  ...
  "sheet-bend": {
    ...
    tieAbilityUnderCondition: tie("good", "good", "fair", "good"),
    retieTempoFit: "fast",
    strengthRetentionBand: band(45, 65, "Animated Knots working-bend class. Not a splice. Tails must exit the same side."),
  ...
  "double-sheet-bend": {
    ...
    retieTempoFit: "moderate",
    strengthRetentionBand: band(55, 75, "Animated Knots: more stable than a single sheet bend on a mismatch."),
  ...
  "rolling-hitch": {
    ...
    tieAbilityUnderCondition: tie("fair", "fair", "poor", "fair"),
    retieTempoFit: "moderate",
    strengthRetentionBand: band(50, 70, "Grip hitch. Animated Knots / field practice: slides first. Surface-dependent."),
    failsWhen: ["Turns on the wrong side of the load", "Slick HMPE standing part", "Expected to hold both directions"],
    diameterMismatchTolerance: "n/a",
    guidesFriendly: false,
    sourceId: "animated-knots",
    reviewedDate: "2026-08-14",
  ...
  "figure-8-stopper": {
    ...
    tieAbilityUnderCondition: tie("excellent", "good", "good", "good"),
    retieTempoFit: "instant",
    strengthRetentionBand: band(50, 70, "Stopper only — not a working-join figure. Band is 'will not pull through,' not rope-break."),
