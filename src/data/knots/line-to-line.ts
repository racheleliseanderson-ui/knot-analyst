...
export const LINE_TO_LINE_KNOTS: KnotContent[] = [
  {
    ...
    steps: [
      {
        order: 1,
        instruction: "Overlap the two lines by 6–8 in.",
      },
      {
        order: 2,
      ...
      {
        order: 5,
        instruction: "Trim both tags short but not flush into the barrels.",
      },
    ],
    commonMistakes: [
    ...
    relatedKnots: ["fg", "alberto", "blood", "surgeons"],
  ...
  },
  {
    ...
    steps: [
      ...
      {
        order: 4,
        instruction: "Seat hard by pulling braid and leader oppositely. Trim leader tag very close; leave a short braid tag if preferred.",
      },
    ],
    commonMistakes: [
      "Insufficient wraps",
    ...
    diagnostics: [
      {
        ...
        fixes: ["Retie under firm leader tension", "Add wraps", "Practice on the dock, not in a fish fight"],
        severity: "stop",
        confidence: "high",
      },
      {
        ...
        fixes: ["Use Alberto or Double Uni until FG is reliable", "Build muscle memory with 20 practice reps"],
        severity: "watch",
        confidence: "high",
      },
    ],
    ...
    relatedKnots: ["alberto", "double-uni", "albright"],
  ...
  },
  {
    ...
    steps: [
      ...
      { order: 2, instruction: "Pass braid through the loop and wrap tightly down the doubled leader ~7 times." },
      { order: 3, instruction: "Wrap back up toward the loop ~7 times." },
      { order: 4, instruction: "Pass braid back through the loop the same direction it entered; moisten and seat hard." },
    ...
    relatedKnots: ["fg", "albright", "double-uni"],
  ...
  },
  {
    ...
    steps: [
      ...
      { order: 2, instruction: "Pass lighter line through the loop and wrap tightly around both legs of the loop ~10 times." },
      { order: 3, instruction: "Pass lighter tag back through the loop (same direction it entered)." },
  ...
  },
  {
    ...
    steps: [
      ...
      { order: 4, instruction: "Pass tags through the center opening in opposite directions." },
      { order: 5, instruction: "Moisten and pull standing lines slowly until the barrel forms; trim tags." },
    ],
    commonMistakes: ["Diameter mismatch", "Unequal wrap counts", "Pulling tags instead of standing lines to seat"],
    diagnostics: [
      {
        id: "blood-hinge",
  ...
  },
  {
    ...
    notIdealFor: ["Situations needing the absolute slimmest barrel", "Critical braid-to-leader offshore connections"],
    lineMaterials: ["mono", "fluoro"],
    difficulty: "beginner",
    ...
    steps: [
      ...
      { order: 2, instruction: "Form a loop as if tying an overhand with both lines together." },
      { order: 3, instruction: "Pass both tags through the loop twice (double surgeon) or three times for extra security." },
      { order: 4, instruction: "Moisten and pull all four ends to seat a compact knot; trim tags." },
    ],
    commonMistakes: ["Single pass only when a double is needed", "Dry seating", "Uneven pull leaving a loose side"],
    diagnostics: [
      {
        id: "surg-slip",
