...
export const CONNECTION_MODEL_META_BOATING_2: Record<string, ConnectionModelMeta> = {
  "water-bowline": {
    ...
    strengthRetentionBand: band(
      60,
      75,
      "Animated Knots water-bowline class: same working-loop band as a bowline, clove collar resists wet capsize.",
    ),
  ...
  "bowline-on-a-bight": {
    ...
    strengthRetentionBand: band(
      60,
      70,
      "Animated Knots: two mid-line loops. Band is the working-loop class when the bight encircles both standings.",
    ),
    failsWhen: [
      "Bight never encircled both standing parts",
      "Used for three-way load",
  ...
  "alpine-butterfly": {
    ...
    strengthRetentionBand: band(
      60,
      75,
      "Animated Knots mid-line loop. Both ends and the loop can be loaded. Published working bands commonly 60–75%.",
    ),
  ...
  "cow-hitch": {
    ...
    strengthRetentionBand: band(
      45,
      65,
      "Animated Knots cow hitch / lark's head. Holds when both legs load; documented slip on a single-leg load.",
    ),
  ...
  "buntline-hitch": {
    ...
    strengthRetentionBand: band(
      60,
      75,
      "Animated Knots: excellent jamming hitch. Band is hold, not easy-release.",
    ),
    failsWhen: [
  ...
  "icicle-hitch": {
    ...
    strengthRetentionBand: band(
      50,
      75,
      "Grip hitch. Animated Knots: holds on tapers and slick standing parts a rolling hitch slides on. Surface-dependent.",
    ),
  ...
  "truckers-hitch": {
    ...
    strengthRetentionBand: band(
      50,
      70,
      "Tensioning system, not a rope-break figure. Advantage ~2:1–3:1; lock is two half hitches.",
    ),
    failsWhen: [
      "Loop collapses under purchase",
  ...
  "zeppelin-bend": {
    ...
    strengthRetentionBand: band(
      70,
      85,
      "Animated Knots secure bend class. Published tests commonly 70–85% dressed; does not jam.",
    ),
    failsWhen: [
  ...
  "carrick-bend": {
    ...
    strengthRetentionBand: band(
      65,
      80,
      "Animated Knots hawser bend. Seize the tails on a standing job. Band is dressed-and-seized.",
    ),
  ...
  "ashley-stopper": {
    ...
    strengthRetentionBand: band(
      50,
      70,
      "Stopper only. Animated Knots: bulky three-lobed stopper. Band is 'will not pull through,' not rope-break.",
    ),
