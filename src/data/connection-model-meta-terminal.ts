...
import type { ConnectionModelMeta, ConditionAbility, RetieTempo } from "@/data/connection-model-meta";
...
export const CONNECTION_MODEL_META_TERMINAL: Record<string, ConnectionModelMeta> = {
  "berkley-braid": {
    ...
    strengthRetentionBand: band(85, 95, "High on braid when doubled and seated; published single figures treated as technique-dependent band."),
  ...
  davy: {
    ...
    strengthRetentionBand: band(85, 92, "Solid tippet band when fully seated; speed is the primary job."),
  ...
  "double-davy": {
    ...
    tieAbilityUnderCondition: tie("good", "good", "good", "good"),
    retieTempoFit: "fast",
    strengthRetentionBand: band(88, 95, "Slightly more secure than single Davy when the second pass seats."),
  ...
  "egg-loop": {
    ...
    retieTempoFit: "moderate",
    strengthRetentionBand: band(85, 92, "High when shank wraps are even; geometry matters as much as raw retention."),
  ...
  orvis: {
    ...
    tieAbilityUnderCondition: tie("good", "good", "good", "good"),
    retieTempoFit: "fast",
    strengthRetentionBand: band(88, 95, "High compact band on mono/fluoro tippet when seated fully."),
  ...
  turle: {
    ...
    tieAbilityUnderCondition: tie("fair", "fair", "fair", "fair"),
    retieTempoFit: "moderate",
    strengthRetentionBand: band(75, 88, "Moderate band; fly alignment is the job more than peak retention."),
  ...
  baja: {
    ...
    tieAbilityUnderCondition: tie("fair", "fair", "poor", "fair"),
    retieTempoFit: "moderate",
    strengthRetentionBand: band(85, 95, "Strong band on heavy mono/fluoro when wraps are even and seated wet."),
  ...
  clinch: {
    materialsValidityMatrix: {
      main: monoFluoro,
      invalidPairs: [{ main: "braid", secondary: "braid", reason: "Basic clinch slips on braid; use Palomar/Uni/Berkley Braid" }],
    },
    tieAbilityUnderCondition: tie("good", "good", "good", "good"),
    retieTempoFit: "fast",
    strengthRetentionBand: band(70, 88, "Lower band than Improved Clinch; adequate when wraps are sufficient."),
