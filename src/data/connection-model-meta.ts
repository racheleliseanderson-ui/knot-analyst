...
import { CONNECTION_MODEL_META_BOATING_3 } from "@/data/connection-model-meta-boating-3";
...
const CONNECTION_MODEL_META_CORE: Record<string, ConnectionModelMeta> = {
  palomar: {
    ...
    strengthRetentionBand: band(
      90,
      100,
      "Typically high 90s when doubled line seats clean; braid often near top of band.",
    ),
    failsWhen: [
  ...
  "improved-clinch": {
      ...
      invalidPairs: [
        {
          main: "braid",
          secondary: "braid",
          reason: "Slippery braid terminals need Uni/Palomar family",
        },
      ],
    },
    ...
    strengthRetentionBand: band(
      78,
      95,
      "Solid on mono/fluoro when improved pass is complete; poor on braid.",
    ),
    failsWhen: [
      "Too few wraps on the standing part",
      "Skipped improved tuck",
      "Braid used as primary terminal",
      "Dry seat on fluoro",
    ],
    diameterMismatchTolerance: "n/a",
    guidesFriendly: true,
  ...
  "uni-knot": {
    ...
    strengthRetentionBand: band(
      82,
      95,
      "Strong multi-material terminal when barrel is uniform and locked at the eye.",
    ),
  ...
  trilene: {
    ...
    strengthRetentionBand: band(
      85,
      95,
      "Double-pass eye friction helps mono/fluoro; not a braid primary.",
    ),
    failsWhen: ["Single pass only", "Dry seat on the double-pass", "Tiny eyes that will not accept double pass"],
    diameterMismatchTolerance: "n/a",
    guidesFriendly: true,
    sourceId: "fishingknots-db",
    reviewedDate: "2026-08-13",
  ...
  snell: {
    ...
    strengthRetentionBand: band(
      85,
      95,
      "Shank-aligned pull; strength is geometry + wrap compression, not eye friction alone.",
    ),
    failsWhen: ["Crossed shank wraps", "Too few shank wraps", "Finish short of the eye", "Loose shank column"],
    diameterMismatchTolerance: "n/a",
    guidesFriendly: true,
  ...
  "non-slip-mono-loop": {
    ...
    strengthRetentionBand: band(
      80,
      100,
      "High when non-slip structure completes; collapses if tag path is wrong.",
    ),
    failsWhen: ["Loop cinches closed", "Too few wraps before the non-slip lock", "Wrong tag path through overhand"],
    diameterMismatchTolerance: "n/a",
    guidesFriendly: true,
    sourceId: "fishingknots-db",
    reviewedDate: "2026-08-13",
  ...
  rapala: {
    ...
    strengthRetentionBand: band(
      85,
      95,
      "Hardbait loop family; free-swing depends on completed non-slip lock.",
    ),
  ...
  "san-diego-jam": {
    ...
    strengthRetentionBand: band(
      88,
      96,
      "High on heavy fluoro/jig eyes when both loop passes complete and stack rolls down.",
    ),
    failsWhen: [
      "Missed second loop pass",
      "Wraps toward the eye instead of away",
      "Dry seat on fluoro",
    ],
    diameterMismatchTolerance: "n/a",
    guidesFriendly: true,
  ...
  "double-uni": {
    ...
    strengthRetentionBand: band(
      82,
      92,
      "Reliable general connector; lag FG on extreme diameter jumps for guide passage.",
    ),
    failsWhen: [
      "Barrels not butted",
      "Too few wraps on braid side",
      "Extreme mismatch forced through guides",
    ],
  ...
  fg: {
    ...
    strengthRetentionBand: band(
      73,
      100,
      "Near full retention when woven under tension; field-tied competition results show wide technique variance.",
    ),
    failsWhen: [
      "Loose early wraps",
  ...
  alberto: {
    ...
    strengthRetentionBand: band(
      80,
      95,
      "Field-friendlier than FG; typically a step below perfect FG on pure strength.",
    ),
  ...
  albright: {
    ...
    failsWhen: [
      "Too few wraps on the heavier loop",
      "Reversed tag direction",
      "Loose first wraps",
      "Heavy-to-heavy bulk hinge",
    ],
    diameterMismatchTolerance: "wide",
    guidesFriendly: false,
    sourceId: "animated-knots",
  ...
  blood: {
    ...
    strengthRetentionBand: band(
      80,
      92,
      "Slim similar-diameter mono/fluoro join; intolerant of mismatch.",
    ),
  ...
  surgeons: {
    ...
    strengthRetentionBand: band(
      85,
      95,
      "Fast tippet join; bulkier than Blood but cold-hand friendly.",
    ),
  ...
  "bimini-twist": {
    ...
    strengthRetentionBand: band(
      95,
      100,
      "Creates near-full-strength double line when twist column is dense and locked.",
    ),
  ...
  "arbor-knot": {
    ...
    strengthRetentionBand: band(
      50,
      80,
      "Rig-up only — must resist spool slip while first wraps bed; not a fighting terminal.",
    ),
  ...
  yucatan: {
    ...
    strengthRetentionBand: band(
      90,
      100,
      "Doubled braid to leader; near full retention when Bimini (or equivalent double) base is sound.",
    ),
    failsWhen: [
  ...
  "slim-beauty": {
    ...
    strengthRetentionBand: band(
      85,
      95,
      "High when figure-8 locks and wraps seat; cited as competitive with other slim braid-leader joins.",
    ),
    failsWhen: [
      "Loose figure-8 that never locks",
      "Too few wraps on a heavy leader",
      "Incomplete opposing seat",
    ],
    diameterMismatchTolerance: "extreme-ok",
    guidesFriendly: true,
    sourceId: "fishingknots-db",
  ...
  "spider-hitch": {
    ...
    strengthRetentionBand: band(
      90,
      100,
      "Strong practical double on mono/fluoro when wrapped and seated under tension; not a free 100% claim.",
    ),
    failsWhen: [
      "Too few wraps around the doubled loop",
      "Seating without continuous tension",
      "Uninspected cyclic load on a marginal hitch",
    ],
    diameterMismatchTolerance: "n/a",
    guidesFriendly: true,
    sourceId: "fishingknots-db",
  ...
  "nail-knot": {
    ...
    strengthRetentionBand: band(
      85,
      92,
      "Low-profile fly-line to leader; band reflects weaker-side retention when coil is even.",
    ),
    failsWhen: [
      "Uneven or gapped wraps",
      "Coil never transferred onto the fly line",
      "Over-trim before seat completes",
    ],
    diameterMismatchTolerance: "extreme-ok",
    guidesFriendly: true,
    sourceId: "fishingknots-db",
...
export const CONNECTION_MODEL_META: Record<string, ConnectionModelMeta> = {
  ...
  ...CONNECTION_MODEL_META_BOATING_3,
};
...
export function catalogReviewDue(asOf: Date = new Date()): {
  ...
  const dates = Object.values(CONNECTION_MODEL_META)
    .map((m) => m.reviewedDate)
    .sort();
