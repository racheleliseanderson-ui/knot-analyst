...
export const CONNECTION_MODEL_META_BATCH4: Record<string, ConnectionModelMeta> = {
  ...
  "aussie-quickie": {
    ...
    failsWhen: ["Loose early wraps", "Lock hitch never seated after the wraps", "Long stiff tags"],
  ...
  "australian-plait": {
    ...
    failsWhen: ["Loose plait", "End lock never made — the plait dumps", "Too short a double"],
    diameterMismatchTolerance: "n/a",
    guidesFriendly: true,
    sourceId: "field-practice",
    reviewedDate: "2026-08-14",
