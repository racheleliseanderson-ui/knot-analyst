...
export const CONNECTION_MODEL_META_BATCH4: Record<string, ConnectionModelMeta> = {
  "orvis-tippet": {
    ...
    strengthRetentionBand: band(88, 96, "High band on similar-diameter mono/fluoro tippet steps; often cited near 90–95% when seated."),
  ...
  seaguar: {
    ...
    tieAbilityUnderCondition: tie("fair", "fair", "fair", "fair"),
    retieTempoFit: "moderate",
    strengthRetentionBand: band(85, 95, "Strong similar-diameter fluoro/mono join when twists and passes seat clean."),
  ...
  "j-knot": {
    ...
    tieAbilityUnderCondition: tie("fair", "fair", "fair", "fair"),
    retieTempoFit: "moderate",
    strengthRetentionBand: band(88, 98, "High similar-diameter tippet-step band in independent shootout-style testing when seated."),
  ...
  "aussie-quickie": {
    ...
    retieTempoFit: "moderate",
    strengthRetentionBand: band(80, 95, "Competitive braid-leader band when wraps seat; technique-sensitive like the rest of the diameter-jump family."),
  ...
  "needle-knot": {
    ...
    tieAbilityUnderCondition: tie("fair", "fair", "poor", "fair"),
    retieTempoFit: "slow",
    strengthRetentionBand: band(85, 92, "Same family band as Nail Knot when the coil fully seats on the fly-line tip."),
  ...
  "homer-rhode": {
    ...
    tieAbilityUnderCondition: tie("fair", "fair", "fair", "fair"),
    retieTempoFit: "moderate",
    strengthRetentionBand: band(80, 95, "Solid heavy-leader loop band when the non-slip structure completes."),
  ...
  "australian-plait": {
    ...
    strengthRetentionBand: band(90, 100, "High double-line band when the plait is tight and locked; inspect before trusting big fish."),
