...
export const CONNECTION_MODEL_META_BOATING_3: Record<string, ConnectionModelMeta> = {
  "yosemite-bowline": {
    ...
    strengthRetentionBand: band(
      60,
      75,
      "Animated Knots Yosemite-bowline class: same working-loop band as a bowline. The finish secures the tail; it is not extra strength.",
    ),
    failsWhen: [
  ...
  "pile-hitch": {
    ...
    strengthRetentionBand: band(
      50,
      70,
      "Animated Knots pile hitch. Temporary mooring; holds while both legs load. Not a standing-soak figure.",
    ),
    failsWhen: [
      "Bight never recleared the top",
      "Used overnight through a tide",
      "Only one leg loaded",
    ],
    diameterMismatchTolerance: "n/a",
  ...
  "halyard-hitch": {
    ...
    strengthRetentionBand: band(
      60,
      75,
      "Animated Knots: compact shackle hitch. Band is hold, not easy-release — it jams after load.",
    ),
    failsWhen: [
      "Turns never tucked back toward the shackle",
      "Expected to break by hand after a hoist",
  ...
  "midshipmans-hitch": {
    ...
    strengthRetentionBand: band(
      45,
      65,
      "Animated Knots Midshipman's (taut-line alias). The extra inside tuck is the hold. Band is working-tension hold, not rope-break.",
    ),
    failsWhen: [
      "Inside tuck missing (that is a taut-line)",
  ...
  "hunters-bend": {
    ...
    strengthRetentionBand: band(
      65,
      80,
      "Animated Knots Hunter's / Rigger's bend. Holds in synthetic rope; can jam after a heavy load. Dressed working band.",
    ),
    failsWhen: [
      "Same-side tails",
  ...
  "heaving-line-knot": {
    ...
    strengthRetentionBand: band(
      40,
      60,
      "Animated Knots heaving-line knot. Band is throwing mass, not rope-break. Not a block stopper.",
    ),
    failsWhen: [
      "Too few wraps to carry",
      "Used as a load-bearing stopper",
      "Wraps left loose so they dump",
    ],
    diameterMismatchTolerance: "n/a",
    guidesFriendly: false,
    sourceId: "animated-knots",
  ...
  "estar-stopper": {
    ...
    strengthRetentionBand: band(
      50,
      70,
      "Animated Knots EStar. Built for slippery HMPE. Band is 'will not pull through,' not a join. Other stoppers walk in Dyneema.",
    ),
  ...
  "reef-knot": {
    ...
    strengthRetentionBand: band(
      40,
      60,
      "Animated Knots square / reef knot. Binding-hold only. Documented slip when used as a bend — never a rope-break figure.",
    ),
  ...
  constrictor: {
    ...
    strengthRetentionBand: band(
      50,
      70,
      "Animated Knots constrictor. Binding-hold; usually cut rather than untied. Band is hold, not release.",
    ),
    failsWhen: [
  ...
  "timber-hitch": {
    ...
    strengthRetentionBand: band(
      45,
      65,
      "Animated Knots timber hitch. Holds under tension only; collapses unloaded. Band is working hoist, not a standing figure.",
    ),
