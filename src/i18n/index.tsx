...
const en = {
  ...
  "decide.venue": "Venue",
  "decide.venueHint": "Where the connection actually works. Venue sets the conditions it punishes.",
...
const es: Record<Key, string> = {
  ...
  "decide.venue": "Lugar",
  "decide.venueHint": "Dónde trabaja la conexión. El lugar define las condiciones que castiga.",
